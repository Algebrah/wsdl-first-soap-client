 ...
 * 2016-08-03T09:54:05.820-05:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/Projects/AURA/Development/soapclient/src/main/resources/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projects/AURA/Development/soapclient/src/main/resources/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projects/AURA/Development/soapclient/src/main/resources/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
